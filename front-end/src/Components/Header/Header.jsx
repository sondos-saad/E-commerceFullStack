    ...
    <div className="w-full h-[500px] bg-no-repeat bg-cover relative"  style={{ backgroundImage: `url(${HomePhoto})` }} >
       <section className='py-[5rem] relative'>
            <div className=" w-[50%] absolute left-0 ">
                <h2 className='text-[3rem] font-bold'> Order your favorite Peace for your house</h2>
                ...
                <button className='bg-[#D7A184] text-white px-[1rem] py-[.5rem] rounded-3xl font-bold  hover:bg-[#66796B] duration-300'>View Menu</button>
            </div>
       </section>
    </div>
  )
